...
head_c=512
c_per_level = [1280, 1280, 960]  # modify this for different settings
model = dict(
    ...
    diffusion_feature=dict(
        ...
        'up-level2-upsampler-out': True, 'up-level3-repeat2-vit-out': True},
        version='1-5',
        device='cuda',
        attention=None,
        img_size=512,
    ...
    feature_layers=[
        ...
        [('up-level2-upsampler-out', 640), ('up-level3-repeat2-vit-out', 320)],
    ],
