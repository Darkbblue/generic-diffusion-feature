# NOTE: overwriting with this file will disable the normal t2i generation pipeline with pixart-sigma
# turning it into i2i pipeline instead
# so you may want to backup the original file before overwriting
